...
async (conn, mek, m, { from, q, reply }) => {
    try {
        ...
        if (!q) return reply(`
*🤖 SHIRO-MD AI IMAGE GENERATOR 🖼️*

Usage: .shiro-mdai <image description>
Example: .shiro-mdai Beautiful landscape with mountains
...
`);
        ...
        await conn.sendMessage(from, {
            image: response.data,
            caption: `*🤖 SHIRO-MD AI IMAGE GENERATOR 🖼️*

*📝 Prompt:* ${q}

*Generated by SHIRO-MD AI*
...
`,
        ...
        console.error("SHIRO-MD AI Image Generation Error:", error);
