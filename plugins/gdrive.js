...
reply(`\n⬇️  *SHIRO-MD GDRIVE DOWNLOADER*  ⬇️
...
conn.sendMessage(jid, { document: { url: res.downloadUrl }, fileName: "🎬 SHIRO-MD MOVIE DOWNLOADER 🎬\n"+name, mimetype: res.mimetype , caption : "\n"+name+"\n\n> *SHIRO-MD*"})
} catch (e) {
