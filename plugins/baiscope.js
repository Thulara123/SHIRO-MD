...
baiscope`
        let opts = {
                image: results[0].img,
                header: '_*SHIRO BAISCOPE DOWNLOADER*_',
...
baiscope`
        let opts = {
                ...
                header: '_*SHIRO-MD BAISCOPE DOWNLOADRE*_',
                footer: 'MOVIE DOWNLOADER BY SHIRO-MD',
                body: info 
...
/*const links = d.find("div.cm-entry-summary > a").attr("href");
           ...
           const dllinks = lin2 ? lin2 : links*/
                ...
                let message = {
                    image: image,
                    header: '🎬━_*SHIRO-MD BAISCOPE SUB DOWNLOADER*_━🎬',
                    footer: 'MOVIE DOWNLOADER BY SHIRO-MD',
                    body: msg
...
await conn.sendMessage(from, {text: SHIROlod[i], edit: key })
	    ...
	    caption: "*🎬 SHIRO-MD MOVIE DOWNLOADER 🎬*",
            mimetype: "application/rar",
            fileName: `SHIRO-MD.rar`,
        };
