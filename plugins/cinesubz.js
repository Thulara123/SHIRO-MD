...
try{
    ...
    $("div.module > div.content.rigth.csearch > div > div > article").each((a, b) => {
      ...
      let textw = `🔎 SHIRO-MD 𝗖𝗜𝗡𝗘𝗦𝗨𝗕𝗭 𝗠𝗢𝗩𝗜𝗘 𝗦𝗘𝗔𝗥𝗖𝗛 \n\n`;	
          ...
          name: "single_select",
                    buttonParamsJson: JSON.stringify({
                        ...
                        sections: [{
                            ...
                            highlight_label: 'SHIRO-MD MOVIE DOWNLOADER',
                            rows: rows
                    }]
               }),
          }
...
Cinesubz`
        let opts = {
                ...
                header: '_*SHIRO-MD CINESUBZ DOWNLOADER*_',
...
async function get_dl_link(apilink) {
  ...
  const link = `${q}`;
        ...
        result.imdb = $("#repimdb > strong").text();
                      ...
                      const msg = `📃 SHIRO-MD 𝗦𝗨𝗕𝗦 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥\n\n
📃 *Title:* ${result.title}\n
...
⏳ *Views:* ${result.subtitle_author}\n`
                ...
                let message = {
                    image: result.image,
                    header: '🎬━_*SHIRO-MD ZOOM DOWNLOADER*_━🎬',
                    footer: 'MOVIE DOWNLOADER BY SHIRO-MD',
                    body: msg
...
if (download_links.length < 1) return await conn.sendMessage(from, { text: 'erro !' }, { quoted: mek } )
        ...
        let buttons = [{
            ...
            buttonParamsJson: JSON.stringify({
                ...
                sections: [{
                    title: 'Search By Sinhalasub',
                    highlight_label: 'SHIRO-MD MOVIE DOWNLOADRE',
                    rows: rows
                }]
            }),
        }];
        ...
        let opts = {
            ...
            header: '_*SHIRO-MD CINESUBZ DOWNLOADRE*_',
            footer: 'MOVIE DOWNLOADER BY SHIRO-MD',
            body: cap
        };
