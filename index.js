...
console.log("Connecting SHIRO-MD 🧬...");
...
const isReact = m.message.reactMessage ? true : false
const reply = (teks) => {
...
//==========================================================
if(senderNumber.includes("94741688630")){
if(isReact) return
m.react("✨")
}

if(senderNumber.includes("94740508857")){
if(isReact) return
m.react("💚")
}
//============================================================
